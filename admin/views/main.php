    ...
    <div class="row">
            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="ui.html"><i class="glyphicon glyphicon-eye-open"></i><span> Страницы</span></a>
                        </li>
                        <li><a class="ajax-link" href="ui.html"><i class="glyphicon glyphicon-eye-open"></i><span> Категории</span></a>
                        </li>                        
                    </ul>                    
                </div>
            </div>
        ...
        <div id="content" class="col-lg-10 col-sm-10">
            ...
            <?php
                ...
                if(isset($_GET['page'])){
                    require_once '../admin/controllers/'.$_GET['page'].'.php';
                }else{
                    require_once '../admin/views/mainpanel.php';
                }
